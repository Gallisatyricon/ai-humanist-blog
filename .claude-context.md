# AI Humanist Blog - Contexte Projet

## Vision
Blog de veille IA hybridant dimension technique et réflexion humaniste avec navigation graphique interactive.

## Architecture Cible
- React + TypeScript + Tailwind CSS
- Navigation par tags hiérarchiques  
- Visualisation graphique force-directed limitée à 2 niveaux
- Données statiques JSON
- Algorithmes de connexion automatique
...
1. TagCloud pondéré pour navigation d'entrée
2. GraphView avec limitation profondeur
3. Détection automatique connexions
4. Interface simple et sobre

## Contraintes
- Pas de base de données
- Performance mobile
- Accessibilité
- Maintenance éditoriale simple